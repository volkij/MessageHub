...
{
    public class WebHookSmsService : IProvider<MessageHub.Shared.SmsMessage>
    {
        ...
        public WebHookSmsService(ILogger logger, MessageHub.Shared.SenderConfig senderConfig)
        {
            Logger = logger;
